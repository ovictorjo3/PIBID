...
\section{Definição}
    ...
    \begin{frame}{Convenção importante}
    	No caso do logaritmo decimal (isto é, quando a base do logaritmo for 10), podemos omiti-la da notação:
    	...
    	\uncover<3->{
    	\textit{O logaritmo de base \textbf{\euler} recebe o nome de \textbf{logaritmo natural} ou \textbf{logaritmo neperiano}, em homenagem a John Napier, considerado um dos responsáveis pelo desenvolvimento dos logaritmos.}
    	}
